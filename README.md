...
|  <img src="https://github.com/OlyaBorzynska.png" width="50" height="50">  | [Olha Borzynska](https://github.com/OlyaBorzynska)     | Frontend Dev     | **Feedback Section:** Інтеграція слайдера `Swiper.js`, рендер відгуків з БД та візуалізація оцінок через Star Rating.           |
